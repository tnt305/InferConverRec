...
if __name__ == '__main__':
    kg = load_kg('data/dbpedia/mappingbased-objects_lang=en.ttl')
    if 'kg.pkl' in os.listdirs('data/dbpedia'):
        pass
    elif 'kg.pkl' in os.listdirs('data'):
        shutil.copy('data/kg.pkl', 'data/dbpedia/kg.pkl')
    else:
